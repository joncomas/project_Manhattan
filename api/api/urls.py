...
urlpatterns = [
    path('register/', views.Register.as_view(), name='id-register'),
    ...
    path('users/<int:user_id>/campaigns/<int:campaign_id>/results/', views.ResultsView.as_view(), name='all-results'),
